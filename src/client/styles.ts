...
/* Pure-CSS caret: the host primitives' chevron icon names differ per DSH line
   (0.1.5 IconChevronDownOutline14 vs 0.1.7 IconChevronDownOutlineRegular),
   so no static import can serve both — importing the 0.1.5 name makes the
   client bundle fail to resolve on 0.1.7, taking the whole card down. A border
